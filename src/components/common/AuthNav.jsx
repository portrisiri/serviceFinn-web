...
// -----***** PRIVATE *****--------------------------------------------------------Check again
  ...
  if (role === 'USER'){
    return (
     ...
     <div className='flex flex-col'>
            ...
            <span className='text-gray-600 text-[11px] ml-6'> {user.publicMetadata?.role} </span>
     </div>
     ...
     <div className='flex flex-col'>
      ...
      <div className="dropdown dropdown-end">
        ...
        <ul tabIndex={0} className="dropdown-content menu bg-[#FFE047] text-[#2B293D] rounded-box z-[1] w-52 p-2 shadow">
          ...
          <li><Link to='/provider/shop'>Shop Management</Link></li>
          <li><Link to='/provider/booking-management'>Booking Management</Link></li>
          <li><Link to='*'>Orders Management</Link></li>
  ...
  if (role === 'ADMIN'){
    return (
      ...
      <div className='flex flex-col'>
             <p className='text-black text-sm font-bold'> {user.firstName ? user.firstName : "ADMINISTRATOR"} </p>
