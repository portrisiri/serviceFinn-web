...
function CreateShopSection(props) {
    ...
    return (
        ...
        <option key={el.subCatId} value={el.subCatName}>
          {el.subCatName}
                ...
                <h3 class="mb-4 my-8 font-semibold text-lg text-blue-900 dark:text-white">Working Time (Section)</h3>
                <div className="mb-4">
                    <label className="block text-md mx-10 text-blue-900 font-semibold">
                        Duration
                        <input
                            type="+number"
                            className="input input-bordered text-center w-20 mx-2"
                            required
                            placeholder="0"
                        />
                        <span className="text-md  text-blue-900">hours</span>
                    </label>
                </div>
                <div className='flex'>
                ...
                <div class="flex items-center ">
                    ...
                    <label for="vue-checkbox" class="w-full py-3 ms-2 text-sm font-medium text-blue-900 dark:text-gray-300">Sun</label>
                    <div className='mx-5'>
                ...
                <div class="flex items-center mx-24 my-4 ">
                    ...
                    <label for="end-time" class="block py-2 mx-8 mb-0 text-sm font-medium text-blue-900 dark:text-white"></label>
                    <div class="relative">
                        <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none">
                            <svg class="w- h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <input type="time" id="end-time" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" value="00:00" required />
