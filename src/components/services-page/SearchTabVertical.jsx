...
const services = [
  { name: 'All Services', emoji: '😍', value: false },
...
function SearchTabVertical(props) {
  const { searchParams, setSearchParams, currentLocation } = props;
  ...
  return (
    <div className="flex flex-col mx-auto bg-white rounded-lg gap-4 max-w-lg md:max-w-6xl">
      {/* CatName Selection */}
      <div className="w-full">
        <select
          className="w-full p-[10.5px] border rounded-md focus:ring focus:ring-blue-300 h-[50px]"
          value={searchParams.categoryId}
          onChange={(e) => setSearchParams((prv) => ({ ...prv, categoryId: e.target.value }))}
        >
...
export default SearchTabVertical;
