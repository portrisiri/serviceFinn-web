            ...
            <div className="bg-white w-[80%] max-w-5xl flex h-[900px] rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="flex flex-col flex-1 justify-center items-center">
                ...
                <form onSubmit={handleSubmit(onNext)} className="w-3/4">
                  ...
                  <select {...register('skill', { required: 'Skill is required' })} defaultValue="skill" className="select w-full">
                  ...
                  <button type="button" onClick={onPrev} className="btn btn-secondary w-1/2 mt-4 mr-2">Previous</button>
                  <button type="submit" className="btn btn-primary w-1/2 mt-4">Next</button>
                </form>
              </div>
            </div>
          </div>
